...
<div class="fixed top-0 left-0 w-screen h-screen border-0 bg-white z-50 flex flex-col gap-8 p-5 px-8 md:hidden">
    ...
    <div class="flex flex-col gap-4 flex-1">
        <button on:click={ () => reroute("/student/report-form")} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
            <p class="duration-200 group-hover:pl-2 poppins text-3xl font-semibold">Make Report <i class="fa-solid fa-chevron-right text-xl pl-4" /></p>
        </button>
        <button on:click={ () => reroute("/student/form-reports")} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
            <p class="duration-200 group-hover:pl-2 poppins text-3xl font-semibold">View Reports <i class="fa-solid fa-chevron-right text-xl pl-4" /></p>
        </button>
        <button on:click={ () => reroute("/student/ranking")} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
            <p class="duration-200 group-hover:pl-2 poppins text-3xl font-semibold">View Ranking <i class="fa-solid fa-chevron-right text-xl pl-4" /></p>
        </button>
        <button on:click={ () => reroute("/student/coupons")} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
            <p class="duration-200 group-hover:pl-2 poppins text-3xl font-semibold">Shop Coupon <i class="fa-solid fa-chevron-right text-xl pl-4" /></p>
        </button>
        <button on:click={ () => reroute("/student/coupon")} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
            <p class="duration-200 group-hover:pl-2 poppins text-3xl font-semibold">My Coupon <i class="fa-solid fa-chevron-right text-xl pl-4" /></p>
        </button>
        <button on:click={ () => reroute("/student/profile")} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
            <p class="duration-200 group-hover:pl-2 poppins text-3xl font-semibold">Profile <i class="fa-solid fa-chevron-right text-xl pl-4" /></p>
        </button>
    </div>
    ...
    <header class="flex flex-col relative z-20">
        <div class="max-w-[1400px] mx-auto w-full flex items-center justify-between p-4 py-6">
            ...
            <nav class="hidden md:flex items-center gap-4 lg:gap-6">
                ...
                <a class="duration-200 hover:text-red-700 cursor-pointer" href="/student/ranking">View Ranking</a>
