...
<Sectionwrapper>
    ...
    <div class="flex flex-col gap-10 flex-1 items-center justify-center pb-10 md:pb-14 w-full">
		...
		<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full" on:submit|preventDefault={updatecoupons}>
			{#if coupons.title}
			<div class="mb-6">
			...
			<button type="submit" class="px-4 py-2 mt-4 specialBtnDark rounded hover:bg-red-900">Submit</button>
