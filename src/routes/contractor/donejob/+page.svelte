...
<Sectionwrapper>
    ...
    <div class="flex flex-col gap-10 flex-1 items-center justify-center pb-10 md:pb-14 w-full">
		<h2 class="text-3xl sm:text-2xl md:text-3xl lg:text-4xl max-w-[1200px] mx-auto w-full text-center font-semibold">Done Job</h2>
				...
				<table class="w-full border-collapse">
					<thead class="bg-gray-200">
						<tr>
							...
							<th class="py-2 px-4 border text-center">Options</th>
						</tr>
					</thead>
		...
		{:else}
			<p class="text-12l sm:text-1xl md:text-2xl lg:text-2xl max-w-[1200px] mx-auto w-full text-center font-semibold">No available done job</p>
		{/if}
	</div>
</Sectionwrapper>